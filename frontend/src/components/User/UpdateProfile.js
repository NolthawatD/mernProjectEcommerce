      ...
      {loading ? (
        ...
        <Fragment>
          ...
          <div className={classes.updateProfileContainer}>
            <div className={classes.updateProfileBox}>
              <h2 className={classes.updateProfileHeading}>Update Profile</h2>
              <form
                className={classes.updateProfileForm}
                encType='multipart/form-data'
                onSubmit={updateProfileSubmit}
              >
                <div className={classes.updateProfileName}>
                  <FaceIcon />
                  <input
                    type='text'
                    placeholder='Name'
                ...
                <div className={classes.updateProfileEmail}>
                  <MailOutlineIcon />
                  <input
                    type='email'
                    placeholder='Email'
